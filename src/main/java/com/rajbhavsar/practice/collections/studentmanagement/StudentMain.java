package com.rajbhavsar.practice.collections.studentmanagement;
...
import com.rajbhavsar.practice.collections.studentmanagement.service.impl.StudentServiceImpl;
        ...
        while (true) {
            ...
            switch (option) {
                ...
                case 2:
                    ...
                    System.out.println(studentService.insert(new Student(rollNumber, firstName, lastName,
                            contactNumber)));
                    break;
                case 3:
                    ...
                    System.out.println(studentService.updateStudent(new Student(rollNumberUpdate, firstNameUpdated, lastNameUpdated,
                ...
                case 6:
                    ...
                    List<Student> searchedStudents = studentService.search(fieldNameSearch, valueSearch);
